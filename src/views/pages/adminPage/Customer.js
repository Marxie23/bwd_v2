...
import CustomerInfoEditCard from "../../../component/CustomerInfoEditCard";
...
const Customer = () => {
      ...
      const exportToPDF = () => {
        ...
        doc.autoTable({
          head: [['Account No', 'Name', 'Meter No', 'Address', 'Status']],
      ...
      <Grid container>
        <Grid item xs={12} lg={6} sx={{display:'flex', justifyContent:'center'}}>
          ...
          <Box sx={{display:'flex', justifyItems:'center'}}>
            <Button variant="contained" color="primary" onClick={exportToPDF} sx={{height:'50px', ml:1}}>
              Export to PDF
            </Button>
